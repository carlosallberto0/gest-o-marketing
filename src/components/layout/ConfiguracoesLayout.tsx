...
export function ConfiguracoesLayout({ children }: ConfiguracoesLayoutProps) {
  ...
  const configItems: MenuItem[] = [
    { icon: LayoutDashboard, label: 'Dashboard', path: '/configuracoes/dashboard', roles: ['super_admin'] },
    { icon: Cog, label: 'Geral', path: '/configuracoes/geral', roles: ['super_admin'] },
    { icon: Users, label: 'Usuários', path: '/configuracoes/usuarios', roles: ['super_admin'] },
    { icon: Building2, label: 'Fornecedores', path: '/configuracoes/fornecedores', roles: ['super_admin'] },
    { icon: Shield, label: 'Perfis e Permissões', path: '/configuracoes/perfis', roles: ['super_admin'] },
  ];

  const filteredMenuItems = configItems.filter(item => {
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="h-[70px] flex items-center justify-center px-5 border-b border-sidebar-border">
            {systemLogo ? (
              ...
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded bg-slate-500 flex items-center justify-center">
          ...
          <div className="px-5 py-3 border-b border-sidebar-border">
            <Badge className="w-full justify-center py-1.5 text-white border-0 bg-slate-500">
              Configurações
            </Badge>
          </div>
