...
interface LoteamentosLayoutProps {
  children: ReactNode;
}
...
export function LoteamentosLayout({ children }: LoteamentosLayoutProps) {
  ...
  const loteamentosItems: MenuItem[] = [
    { icon: LayoutDashboard, label: 'Dashboard', path: '/loteamentos/dashboard', roles: ['super_admin'] },
    { icon: Home, label: 'Lançamentos', path: '/loteamentos/lancamentos', roles: ['super_admin'] },
    { icon: DollarSign, label: 'Pagamentos', path: '/loteamentos/pagamentos', roles: ['super_admin'] },
    { icon: FileText, label: 'Contratos', path: '/loteamentos/contratos', roles: ['super_admin'] },
    { icon: FolderOpen, label: 'Documentos', path: '/loteamentos/documentos', roles: ['super_admin'] },
  ];

  const filteredMenuItems = loteamentosItems.filter(item => {
      ...
      <aside className={cn(
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-5 py-3 border-b border-sidebar-border">
            <Badge className="w-full justify-center py-1.5 text-white border-0 bg-emerald-500">
              Loteamentos
            </Badge>
          </div>
